    ...
    <div>
      ...
      <footer className="backdrop-blur-md w-full">
        <div className="w-full mx-auto text-center max-w-screen-xl p-4 flex flex-col md:flex-row md:items-center md:justify-between">
          ...
          <Link href="https://github.com/sumit7366" className="me-4 md:me-6">
            <span className="hover:text-primary-500 mt-3 text-sm font-medium text-gray-500 sm:mt-0">
              GitHub
            </span>
          </Link>

          <Link href="https://patna-sumit-portfolio.netlify.app/" className="me-4 md:me-6">
            <span className="hover:text-primary-500 mt-3 text-sm font-medium text-gray-500 sm:mt-0">
              Made with ❤️ Sumit
            </span>
          </Link>

          <Link href="https://www.instagram.com/9._sumit/?igsh=eWs4ZTRmcmtzZ2tl#" className="me-4 md:me-6">
            <span className="hover:text-primary-500 mt-3 text-sm font-medium text-gray-500 sm:mt-0">
              Instagram
            </span>
          </Link>

          <Link href="https://www.linkedin.com/in/sumit7366/" className="me-4 md:me-6">
            <span className="hover:text-primary-500 mt-3 text-sm font-medium text-gray-500 sm:mt-0">
              LinkedIn
            </span>
          </Link>
          ...
          <span className="mt-3 text-sm text-gray-500 sm:mt-0">
            <a href="mailto:sumitranjanhisu@gmail.com" className="hover:text-primary-500">
              Connect with me
            </a>
          </span>
        </div>
